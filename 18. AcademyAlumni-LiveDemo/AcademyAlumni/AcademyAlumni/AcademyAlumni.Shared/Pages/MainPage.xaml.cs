...
namespace AcademyAlumni.Pages
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void OnEventsListViewSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            var eventsListView = (sender as ListView);
            var selectedObject = eventsListView.SelectedItem;
            this.Frame.Navigate(typeof(EventDetailsPage), selectedObject);
        }
